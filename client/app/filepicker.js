'use strict';
const filepicker =angular.module('angular-filepicker',[]);

window.filepicker = window.filepicker || {};
window.filepicker.plugin = 'angular_js_lib';'use strict';

filepicker.directive('filepicker', filepickerDirective);
...
filepicker.provider('filepicker', function() {
...
filepicker.service('filepickerService',filepickerService);
...
filepicker.directive('filepickerPreview', filepickerPreviewDirective);
...
filepicker.service('fpUtilService', fpUtilService);
...
filepicker.filter('fpConvert', fpConvert);
...
filepicker.filter('fpUrlFilter', function(){
