const franceMap = (ZonePath) =>{

let cssProperties ={
	mapfill:"#99CC66", // Couleur de remplissage des régions
	maphover_fill:"#22aa22", // Couleur de survol au passage de la souris
	mapstroke:"#FFFFFF",// Couleur des lignes de séparation des régions
	mapstroke_width:1.2,// Epaisseur des lignes de séparation des régions (en points)
	mapWidth:300,// Largeur de la carte en pixels
	mapHeight:300// Hauteur de la carte en pixels (facultatif)
};

let zonePaths = ZonePath.zonePaths;
let paths = {
			Z1: {
			title: "Ain",
			url: "#",
...
return {paths, zonePaths,cssProperties};

};
franceMap.$inject =['ZonePath'];
export {franceMap};