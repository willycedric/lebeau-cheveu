...
import {CustomeraccountController} from './customeraccount.controller';
...
describe('Customeraccount', ()=>{
  ...
  beforeEach(window.module(customeraccount.name));
  ...
  describe('Directive', ()=>{
      ...
      let directive = customeraccountDirective();
      ...
      it('should use the right controller', ()=>{
        expect(directive.controller).to.equal(CustomeraccountController);
      });
  });
});
