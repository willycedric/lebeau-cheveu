...
angular.module('loginResetModule',
 [
  servicesUtilityModule.name,
   securityServiceModule.name
   ]);
angular.module('loginResetModule').config(['$routeProvider', function($routeProvider){
  $routeProvider
    .when('/login/reset', {
...
export const loginResetModule = angular.module('loginResetModule').controller('LoginResetCtrl', [ '$scope', '$location', '$routeParams', '$log', 'security', 'utility',
