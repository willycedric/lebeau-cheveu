...
import {servicesNotificationsModule} from './notifications';
import {servicesLocalizedMessagesModule} from './localizedMessages';
angular.module('servicesI18nNotificationsModule', 
  [
  servicesNotificationsModule.name,
 servicesLocalizedMessagesModule.name
 ]);
export const servicesI18nNotificationsModule = angular.module('servicesI18nNotificationsModule').factory('i18nNotifications', ['localizedMessages', 'notifications', function (localizedMessages, notifications) {
