...
import template from './admin-user.tpl.html';
angular.module('adminUsersDetailModule', [uiRouter, 
  securityAuthorizationModule.name,
  servicesUtilityModule.name, 
  servicesAdminResourceModule.name
]);
angular.module('adminUsersDetailModule').config(['$stateProvider', function($stateProvider){
  $stateProvider
    .state('adminusersid', {
      url:'/admin/users/:id',
      template,
      ...
      title: 'Users / Details',
      resolve: {
        user: ['$q', '$route', '$location', 'securityAuthorization', 'adminResource','$stateParams' ,function($q, $route, $location, securityAuthorization, adminResource,$stateParams){
...
export const adminUsersDetailModule = angular.module('adminUsersDetailModule').controller('UsersDetailCtrl', ['$scope', '$route', '$location', 'utility', 'adminResource', 'user',
