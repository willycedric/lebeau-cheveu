...
import template from './admin-group.tpl.html';
angular.module('adminAdminGroupsDetailModule', [uiRouter,
     securityAuthorizationModule.name,
     servicesUtilityModule.name, 
     servicesAdminResourceModule.name
 ]);
angular.module('adminAdminGroupsDetailModule').config(['$stateProvider', function($stateProvider){
  $stateProvider
    .state('admingroupdetail', {
      url:'/admin/admin-groups/:id',
      template,
      controller: 'AdminGroupsDetailCtrl',
      title: 'Admin Groups / Details',
      resolve: {
        group: ['$q', '$stateParams', '$location', 'securityAuthorization', 'adminResource', function($q, $stateParams, $location, securityAuthorization, adminResource){
...
export const adminAdminGroupsDetailModule = angular.module('adminAdminGroupsDetailModule').controller('AdminGroupsDetailCtrl', ['$scope', '$route', '$location', '$log', 'utility', 'adminResource', 'group',
