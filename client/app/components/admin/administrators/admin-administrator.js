...
import template from './admin-administrator.tpl.html';
angular.module('adminAdministratorsDetailModule', [uiRouter, securityAuthorizationModule.name,
     servicesUtilityModule.name, 
     servicesAdminResourceModule.name]);
angular.module('adminAdministratorsDetailModule').config(['$stateProvider', function($stateProvider){
  $stateProvider
    .state('admindetails', {
      ...
      resolve: {
        administrator: ['$q', '$stateParams', '$location', 'securityAuthorization', 'adminResource', function($q, $stateParams, $location, securityAuthorization, adminResource){
...
export const adminAdministratorsDetailModule = angular.module('adminAdministratorsDetailModule').controller('AdministratorsDetailCtrl', ['$scope', '$route', '$location', '$log', 'utility', 'adminResource', 'administrator',
